...
const tones: Record<Tone, string> = {
  ...
  marigold: "bg-marigold-500 text-on-action ring-marigold-600/50",
  indigo: "bg-inverse text-bark-50 ring-bark-200",
  neutral: "bg-paper/70 text-bark-600 ring-bark-200",
};
